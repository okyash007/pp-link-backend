...
export const createTip = async (data) => {
    ...
    const { visitor_id, creator_id, amount, currency, message, payment_gateway, payment_id } = validationResult.data;
    ...
    try {
        ...
        const values = [visitor_id, creator_id, amount, currency, message, payment_gateway, payment_id];
